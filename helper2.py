...
class CREDA_Project:
    ...
    def __init__(self, filename: str):
        ...
        self.data_lines = file_lines.drop(columns=['addr', 'city', 'postal', 'state']).copy().set_index('TempID')
        del file_lines
    ...
    def clean_addresses(self):
        ...
        self.parsed_addresses = address_lines[['TempID', 'TempIDZ', 'single_address']].set_index('TempIDZ')
        self.address_errors = address_lines[['TempID', 'parsed_addr', 'flags']].set_index('TempID')
